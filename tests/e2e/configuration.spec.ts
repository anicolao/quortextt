...
test.describe('Configuration Screen', () => {
  ...
  test('should display the edge-based lobby with color buttons', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('configuration-empty.png');
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/001-initial-state.png' });
  });
  ...
  test('should add a player when clicking a color button', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await expect(page).toHaveScreenshot('configuration-one-player.png');
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/002-player-added.png' });
  });
  ...
  test('should add multiple players from different edges', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/003-multiple-players.png' });
  });
  ...
  test('should not add more than 6 players', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/004-max-players.png' });
  });
  ...
  test('should remove a player when X button is clicked', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/005-player-removed.png' });
  });
  ...
  test('should change player color by removing and re-adding', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/007-color-changed.png' });
  });
  ...
  test('should start game when Start button is clicked with players', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/009-game-started.png' });
  });
  ...
  test('should not allow duplicate colors', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/010-no-duplicate-colors.png' });
  });
  ...
  test('User Story: Complete player configuration flow', async ({ page }) => {
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/003-second-player-added.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/004-third-player-added.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/005-fourth-player-added.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/006-fifth-player-added.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/007-max-players.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/008-player-removed.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/009-second-player-removed.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/010-third-player-removed.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/011-two-players-ready.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/012-seating-screen.png' });
    ...
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/013-player1-seated.png' });
    ...
    expect(state.game.screen).toBe('gameplay');
    await pauseAnimations(page);
    await captureNarrativeScreenshot(page, { path: 'tests/e2e/user-stories/001-player-configuration/014-gameplay-started.png' });
  });
});
