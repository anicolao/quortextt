...
Each screenshot shows one player's turn placing a tile:

![004-turn-1-player-P4](./004-turn-1-player-P4.png)
![004-turn-2-player-P1](./004-turn-2-player-P1.png)
![004-turn-3-player-P5](./004-turn-3-player-P5.png)
![004-turn-4-player-P2](./004-turn-4-player-P2.png)
![004-turn-5-player-P3](./004-turn-5-player-P3.png)
![004-turn-6-player-P6](./004-turn-6-player-P6.png)
...
Given randomized seating order: `[P5, P6, P4, P2, P1, P3]`

1. P5 selects edge 0 (starting player)
2. P6 selects edge 1
3. P4 selects edge 2
4. P2 selects edge 3
5. P1 selects edge 4
...
- Turn 1: P5 (edge 0) - starting player
- Turn 2: P6 (edge 1) - next clockwise
- Turn 3: P4 (edge 2)
- Turn 4: P2 (edge 3)
- Turn 5: P1 (edge 4)
- Turn 6: P3 (edge 5)

The `players` array after seating is reordered to: `[P5, P6, P4, P2, P1, P3]` (clockwise from starting player), and `currentPlayerIndex` simply increments 0→1→2→3→4→5.

## Continuous Flow

This test is generated by a single continuous execution that:
1. Adds 6 players to configuration
2. Starts game (transitions to seating)
